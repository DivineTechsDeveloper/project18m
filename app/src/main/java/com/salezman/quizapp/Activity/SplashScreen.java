...
import com.salezman.quizapp.Util.ConnectivityReceiver;
import com.salezman.quizapp.Util.Constant;
import com.salezman.quizapp.Util.MyApp;
...
public class SplashScreen extends AppCompatActivity implements ConnectivityReceiver.ConnectivityReceiverListener {
    ...
    private void printKeyHash() {
        ...
        try {
            PackageInfo info = getPackageManager().getPackageInfo("com.salezman.quizapp", PackageManager.GET_SIGNATURES);
