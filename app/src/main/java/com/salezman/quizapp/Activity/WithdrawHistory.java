package com.salezman.quizapp.Activity;
...
import com.salezman.quizapp.Adapter.WithdrawHistoryAdapter;
import com.salezman.quizapp.Model.ProfileModel.ProfileModel;
import com.salezman.quizapp.Model.WithdrawalModel.Result;
import com.salezman.quizapp.Model.WithdrawalModel.WithdrawalModel;
import com.salezman.quizapp.R;
import com.salezman.quizapp.Util.PrefManager;
import com.salezman.quizapp.Util.Utility;
import com.salezman.quizapp.Webservice.AppAPI;
import com.salezman.quizapp.Webservice.BaseURL;
...
public class WithdrawHistory extends AppCompatActivity {
    ...
    List<com.salezman.quizapp.Model.ProfileModel.Result> profileList;
                ...
                try {
                    if (response.code() == 200 && response.body().getStatus() == 200) {
                        ...
                        if (response.body().getResult().size() > 0) {
                            profileList = new ArrayList<com.salezman.quizapp.Model.ProfileModel.Result>();
